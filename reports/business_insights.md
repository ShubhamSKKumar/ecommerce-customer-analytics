...
### Insight 3: Peak Sales Seasonality
...
* **Action:** Front-load marketing spend starting in mid-October and ensure top-performing products are overstocked by November 1st.

### Insight 4: Repeat Customers Drive Higher Average Order Value (AOV)
...
### Insight 5: Geographic Concentration of Revenue
...
### Insight 6: Large "Potential Loyalist" Segment Needs Nurturing
...
### Insight 7: Product Catalog has a Long Tail of Non-Performers
...
### Insight 8: New Customer Acquisition is Stagnating
